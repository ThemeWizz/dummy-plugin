...
console.log(response);
				if (response.success) {
					...
					licenseContainer.find('.license-change').addClass('hidden');
					licenseContainer.find('.deactivate-license').removeClass('hidden');
				} else {
					...
					licenseContainer.find('.license-message').removeClass('hidden');
					licenseContainer.find('.deactivate-license').addClass('hidden');
				}
		...
		$.ajax({
			...
			success: function(response) {
				if (response.success) {
					...
					licenseContainer.find('.license-change').removeClass('hidden');
				} else {
					var errorContainer = licenseContainer.find('.current-license-error');
